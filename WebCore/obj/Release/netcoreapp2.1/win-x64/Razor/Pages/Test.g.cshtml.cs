#pragma checksum "C:\Users\SG422\source\repos\WebCore\WebCore\Pages\Test.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9617deaf69c9a6fbb9683dc0fff4c16a26609793"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9617deaf69c9a6fbb9683dc0fff4c16a26609793", @"/Pages/Test.cshtml")]
...
<div>
    ...
    <a id=""clickTest5"" onclick=""downloadFile()"">下载</a>
</div>
...
<script>
    ...
    function uploadFile() {
        ...
        axios.post('api/Upload/UploadFile', formdata1, {
                headers");
            WriteLiteral(@": { 'Content-Type': 'multipart/form-data' }
            })
            .then(function (response) {
                console.log(response);
            })
    ...
    function downloadFile() {
        axios.get('api/Download/DowloadFile')
            .then(function (response) {
                console.log(re");
            WriteLiteral("sponse);\r\n            })\r\n            .catch(function (error) {\r\n                console.log(response);\r\n            });\r\n    }\r\n</script>\r\n");
            EndContext();
