#pragma checksum "C:\Users\MR.Z\OneDrive\repos\项目\GitHub项目\WebCore\WebCore\Pages\Test.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5b867569c46abff5d47a7e0df6725ad9438a829b"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5b867569c46abff5d47a7e0df6725ad9438a829b", @"/Pages/Test.cshtml")]
...
<script>
    ...
    function clickHandle6() {
        axios.get('api/GetMsg/GetModel?id=1&name");
            WriteLiteral(@"=jom2&price=13&description=jom2的商品')
            .then(function (response) {
                console.log(response);
            })
            .catch(function (error) {
   ...
   ");
    ...
    function uploadFile2() {
      ");
            WriteLiteral(@"  let files = document.getElementById(""fileInput2"").files;
        let formdata1 = new FormData();// 创建form对象
        formdata1.append('file001', files[0]);
        formdata1.append('msg', ""hello"");
        formdata1.append('file002', files[1]);
