#pragma checksum "C:\Users\Administrator\Desktop\Git开源\webcore\WebCore\Pages\Test.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a56b613a89aadcc72d2eb50674fed710414c71db"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a56b613a89aadcc72d2eb50674fed710414c71db", @"/Pages/Test.cshtml")]
...
<div>
    ...
    <");
            WriteLiteral(@"a id=""clickTest5"" onclick=""downloadFile()"">下载图片</a>
...
");
    ...
    function clickHandle6() {
        axios.get('api/GetMsg/GetModel?id=1&name=jom2&price=13&descri");
            WriteLiteral(@"ption=jom2的商品')
            .then(function (response) {
                console.log(response);
            })
            .catch(function (error) {
  ...
  ");
            WriteLiteral(@"  function clickHandle9() {
